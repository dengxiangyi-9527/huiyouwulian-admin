<template>
  <div class="login-container">
    <div class="login-weaper  animated bounceInDown">
      ...
      <p class="login-tip">{{ website.infoTitle}} v 2.0</p>
      <div class="login-border">
        <div class="login-main">
          <h4 class="login-title">
            <el-select v-model="active" class="login-select animated fadeIn" placeholder="点击请选择租户"
              @change="handleCommand">
              <el-option v-for="tenant in tenantList" :key="tenant.id" :label="tenant.name"
    ...
    <div class="login-copyright">
      Copyright © 2019 api.qcwlpt.com. All rights reserved.
    </div>
