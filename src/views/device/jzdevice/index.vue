...
<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading"
      ...
      <el-table-column prop="size" header-align="center" align="center" label="序号">
      </el-table-column>
      <el-table-column prop="deviceId" header-align="center" align="center" label="设备编号">
      </el-table-column>   
      <el-table-column prop="deviceIccidId" header-align="center" align="center" label="物联卡号">
      </el-table-column>
...
<script>
import { fetchList, delObj, memberList, edornUrl, adornUrl, validOnLine } from '@/api/device/jzdevice'
