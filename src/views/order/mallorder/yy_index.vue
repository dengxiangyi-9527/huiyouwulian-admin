<template>
  <div class="mod-config">
    <basic-container>
      <!-- 查询和其他操作 -->
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getPageDataList()">
        ...
        <el-button class="filter-item" type="primary" icon="el-icon-search" @click="getPageDataList">查找
        </el-button>
      ...
      <!--<table-form v-if="addOrUpdateVisible" ref="addOrUpdate" @refreshDataList="getPageDataList"></table-form>-->
      ...
      <el-dialog :visible.sync="refundDialogVisible" title="退款">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="confirmRefund" :disabled="isDis">确定</el-button>
        </div>
      </el-dialog>
    </basic-container>
  </div>
...
<script>
import { fetchList, delObj, getObj, refundOrder, shipOrder,fetchPageList } from '@/api/order/mallorder';
