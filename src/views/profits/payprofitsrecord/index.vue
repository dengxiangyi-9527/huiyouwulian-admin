    ...
    <basic-container>
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <el-form-item label="订单编号">
          <el-input placeholder="请输入订单编号" v-model="dataForm.orderNo" style="width:150px;" clearable>
          </el-input>
        </el-form-item>
        ...
        <el-form-item>
          ...
          <el-button v-if="permissions.profits_payprofitsrecord_trans" type="danger"
            @click="createWithdrawalHandle()" :disabled="dataListSelections.length <= 0" v-db-click>
            新建提现
          </el-button>
          <el-button v-if="permissions.profits_payprofitsrecord_trans" type="success"
            :disabled="dataListSelections.length <= 0" @click="wxTransList()" v-db-click>
            微信零钱转账</el-button>
        </el-form-item>

        <el-form-item style="float:right;">
          总金额: {{totalAmountSelections}}
        </el-form-item>
      </el-form>
      <div class="avue-crud">
...
export default {
  data () {
    return {
      ...
      changeStatusList: [{ lable: '所有', value: null }, { lable: '驻留平台', value: 0 }, { lable: '微信零钱', value: 1 }, { lable: '已提现', value: 2 }, { lable: '提现转账中', value: 3 }, { lable: '支付宝余额', value: 4 }, { lable: '提现审批中', value: 5 },{ lable: '区域签约之前收益', value: 6 },{ lable: '退款-收益取消', value: 7 }],
  ...
  methods: {
    ...
    getDataList () {
      ...
      fetchList(Object.assign({
        ...
        'profitsRefMemberid': this.dataForm.profitsRefMemberid,
    ...
    getMemberList () {
      getMemberList({
        ...
        if (data && data.code === 0) {
          ...
          console.log(this.profitsRefMemberidList)
