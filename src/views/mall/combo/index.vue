<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="center" min-width="180" label="名称" prop="name" />
      ...
      <el-table-column align="center" property="iconUrl" width="100" label="分享图">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="详情" prop="detail">
        <template slot-scope="scope">
          <el-dialog :visible.sync="detailDialogVisible" title="商品详情">
            <div class="detail" v-html="goodsDetail" />
          </el-dialog>
...
<script>
import { listGoods, deleteGoods } from '@/api/combo/goods'
...
export default {
  ...
  methods: {
    ...
    handleUpdate (row) {
      this.$router.push({ path: '/combo/edit', query: { id: row.id } })
    },
    showDetail (detail) {
      console.log(detail)
