<template>
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="宣传画廊">
          <el-upload :action="uploadPath" :limit="5" :file-list="galleryFileList"
        ...
        <el-form-item label="商品详细介绍">
          <editor :init="editorInit" v-model="goods.detail" :row="300" />
        </el-form-item>
      </el-form>
    </el-card>

    <el-card class="box-card">
      <h3>商品套餐选择 <el-button type="primary" :plain="true" @click="selCombo">选择套餐</el-button>
      </h3>
    ...
    <el-card class="box-card">
      ...
      <el-dialog :visible.sync="attributeVisiable" title="设置商品参数">
        <el-form ref="attributeForm" :model="attributeForm" status-icon label-position="left"
          ...
          <el-form-item label="商品参数名称" prop="attribute" label-width="100">
            <el-input style="width:80px" v-model="attributeForm.attribute"></el-input>
          </el-form-item>
    ...
    <div class="op-container">
      ...
      <el-button type="primary" @click="handleEdit" v-db-click>更新商品</el-button>
    </div>
...
<script>
import { detailGoods, editGoods, listCatAndBrand, getSingleList, unloadGoods } from '@/api/combo/goods'
...
export default {
  ...
  data () {
    return {
      ...
      categoryIds: [],
      goods: { picUrl: '', gallery: [], number: '', productPowerType: 0, calnumber: '', shareProfitRatio: 0.0, },
      gallery: [],
      specVisiable: false,
      ...
      //卡片信息
      products: [
        { id: 0, specifications: ['标准'], price: 0.0, number: 0, calnumber: 0, shareProfitRatio: 0.0, productPowerType: 0, url: '' }
      ],
  ...
  methods: {
    init: function () {
      ...
      detailGoods(goodsId).then(response => {
        ...
        this.addGoodsList = response.data.data.comboList
        this.galleryFileList = []
        this.comboProductId = response.data.data.comboProductId
    ...
    handleEdit: function () {
      const finalGoods = {
        ...
        comboList: this.addGoodsList,
        comboProductId: this.comboProductId
      }
      console.log(finalGoods)
      unloadGoods(finalGoods)
        .then(response => {
          this.$notify.success({
            title: '成功',
            message: '修改成功'
