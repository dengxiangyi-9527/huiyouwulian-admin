    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left"
        ...
        <el-form-item label="品牌专区大图：">
          <single-upload v-model="dataForm.bigPic"></single-upload>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus=='create'" type="primary" @click="createData" v-db-click>确定
        </el-button>
        <el-button v-else type="primary" @click="updateData" v-db-click>确定</el-button>
      </div>
    </el-dialog>
...
<script>
import { listBrand, createBrand, updateBrand, deleteBrand } from '@/api/mall/brand'
